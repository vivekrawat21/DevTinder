...
const UserCard = ({ users }) => {
  ...
  const variants = {
    ...
    interested: { x: -400, opacity: 0, scale: 0.8, backgroundColor: "#ddffdd" },
    ignore: { x: 400, opacity: 0, scale: 0.8, backgroundColor: "#ffdddd" },
  };
      ...
      <AnimatePresence>
        {currentUser && (
          <motion.div
            ...
            className="card bg-base-200 shadow-lg rounded-2xl overflow-hidden w-96"
          >
            <div className="card-image flex justify-center items-center pt-4">
              <img
                src={currentUser?.profileUrl || BoyImage}
            ...
            <div className="card-body p-6">
              ...
              <div className="flex justify-center items-center gap-7 text-sm mb-3">
                <div className="flex gap-1">
                  <MdCake className="text-lg text-pink-400 justify-center items-center" />
                  <span>{currentUser?.age || "N/A"} years old</span>
                </div>
              ...
              <p className="text-center text-sm mb-4">
                ...
                <b>: </b>
                {currentUser?.about ||
                  "This is a default about section. Replace it with user-specific details."}
              </p>
              <div className="flex flex-wrap gap-3 justify-center mt-3">
                {(currentUser?.skills || ["Skill 1", "Skill 2", "Skill 3"]).map(
                  (skill, index) => (
                    <span
                      key={index}
